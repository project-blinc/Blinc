...
pub use dropdown_menu::CnDropdownMenu;
...
pub use menu_item::{CnMenuItem, CnMenuSeparator};
pub use number_input::CnNumberInput;
pub use option::CnOption;
pub use pagination::CnPagination;
...
pub fn register_basics(dsl: &BlincDsl) -> BlincDslResult<()> {
    ...
    dsl.register_extern_widget::<CnPagination>()?;
    dsl.register_extern_widget::<CnDropdownMenu>()?;
    dsl.register_extern_widget::<CnMenuItem>()?;
    dsl.register_extern_widget::<CnMenuSeparator>()?;
